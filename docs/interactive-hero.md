...
- Channel centerline radii X **99 mm**, Z **81 mm**. The **15.08 x 25.5 mm** outer profile begins 0.25 mm below the CAD base, covering its full 25 mm height with a small tolerance. Its inner edge clears the measured body bounds so the printed geometry does not break through the diffuser.
