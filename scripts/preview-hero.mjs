...
<style>body{margin:0;background:#171827;color:#e2d8f6;font:14px system-ui}#scene{position:relative;width:100vw;height:calc(100vw / 1.12);max-height:90vh}#scene canvas,#viewport{position:absolute;inset:0}#viewport{pointer-events:none}nav{display:flex;gap:8px;justify-content:center;padding:12px}button{padding:12px 20px;border-radius:24px;border:1px solid #cbbce4;background:white}#status{text-align:center}body[data-capture]{background:transparent}body[data-capture] #scene{width:100vw;height:100vh;max-height:none}body[data-capture] #viewport{right:4.7619%;bottom:13.3333%}body[data-capture] nav,body[data-capture] #status{display:none}</style>
