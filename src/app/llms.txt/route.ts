...
export function GET() {
  ...
  const document = [
    ...
    "",
    "Homepage real-world scenes are concept illustrations, not product photography.",
    "The testimonial carousel contains fictional layout examples, not customer",
    "reviews, endorsements, or evidence of product performance.",
    "",
    "## Companion app",
    "",
